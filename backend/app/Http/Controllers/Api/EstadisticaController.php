...
class EstadisticaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->logAudit(
            ...
            'CREAR',
            'Estadistica',
            (string)$estadistica->id,
            'Registro de nueva estadística para jugador ' . $estadistica->jugador_cedula . ' en partido ' . $estadistica->partido_id
        );
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->logAudit(
            ...
            'Estadistica',
            (string)$estadistica->id,
            'Actualización de estadística para jugador ' . $estadistica->jugador_cedula . ' en partido ' . $estadistica->partido_id
        );
    ...
    public function destroy($id)
    {
        ...
        $this->logAudit(
            ...
            'Estadistica',
            (string)$id,
            'Eliminación de estadística para jugador ' . $estadistica->jugador_cedula . ' en partido ' . $estadistica->partido_id
        );
