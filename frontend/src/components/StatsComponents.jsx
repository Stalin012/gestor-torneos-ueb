            ...
            <div style={{ position: "relative", zIndex: 1 }}>
                ...
                {change !== null && (
                    <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.85rem" }}>
                        ...
                        <span style={{ color: "#a1b0c1" }}>vs. anterior</span>
                    </div>
                )}
            </div>
        </div>
 ...
 */
export const CircularProgress = ({ percentage, size = 120, strokeWidth = 8, color = "#356ed8", label }) => {
    ...
    return (
        <div style={{ position: "relative", display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
            ...
            >
                ...
                {label && <span style={{ fontSize: "0.75rem", color: "#a1b0c1", marginTop: "0.25rem" }}>{label}</span>}
            </div>
        </div>
    );
};
 ...
 */
export const LinearProgress = ({ percentage, height = 8, color = "#356ed8", showLabel = true, label }) => {
    return (
        <div style={{ width: "100%" }}>
            {showLabel && (
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.5rem", fontSize: "0.85rem" }}>
                    <span style={{ color: "#eaeaea", fontWeight: "600" }}>{label || "Progreso"}</span>
 ...
 */
export const MiniBarChart = ({ data, height = 60, color = "#356ed8", label }) => {
    const max = Math.max(...data.map((d) => d.value));

    return (
        <div>
            {label && (
                <p style={{ fontSize: "0.85rem", color: "#a1b0c1", marginBottom: "0.75rem", fontWeight: "600" }}>{label}</p>
            )}
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: "0.5rem", fontSize: "0.7rem", color: "#a1b0c1" }}>
                {data.length > 0 && (
                    <>
