      ...
      <div className="admin-page-header">
        <div>
          ...
          <p style={{ color: "var(--text-muted)", marginTop: "0.25rem" }}>
            Administra disciplinas, categorías y competiciones deportivas.
          </p>
        </div>
        <button className="pro-btn btn-primary" onClick={() => { setCurrentTorneo(null); setIsTorneoModalOpen(true); }}>
          <Plus size={20} style={{ marginRight: '6px' }} /> Crear Torneo
        </button>
      </div>

      {/* KPI CARDS */}
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "1.5rem", marginBottom: "2rem" }}>
        <StatCard title="Total Torneos" value={stats.total} icon={Trophy} color="#38bdf8" />
        <StatCard title="En Curso" value={stats.activos} icon={Activity} color="#f59e0b" trend={{ value: "Live", isPositive: true }} />
        <StatCard title="Finalizados" value={stats.finalizados} icon={CheckCircle} color="#10b981" />
        <StatCard title="Disciplinas" value={stats.deportesCount} icon={Swords} color="#8b5cf6" />
      </div>
