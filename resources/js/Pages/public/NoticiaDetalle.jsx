...
const NoticiaDetalle = () => {
    ...
    if (loading) {
        return (
            <div className="home-wrapper" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh' }}>
                <div className="loading-screen" style={{ color: '#fff' }}>Cargando noticia...</div>
            </div>
        );
    }
    ...
    if (!noticia) {
        return (
            <div className="home-wrapper" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', flexDirection: 'column', gap: '1rem' }}>
                <h2 style={{ color: '#fff' }}>Noticia no encontrada</h2>
    ...
    return (
        <div className="home-wrapper">
            ...
            <div className="container" style={{ paddingTop: '8rem', paddingBottom: '6rem', position: 'relative', zIndex: 10 }}>
                    ...
                    <article className="fade-enter">
                        ...
                        <footer style={{ marginTop: '4rem', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.05)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'linear-gradient(135deg, #3b82f6, #2563eb)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: 700 }}>U</div>
                                <div>
                                    <div style={{ color: '#fff', fontWeight: 600, fontSize: '0.9rem' }}>Redacción UEB SPORT</div>
