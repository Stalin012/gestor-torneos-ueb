            ...
            <div style={{ display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                ...
                <div style={{ flex: 1 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.25rem" }}>
                        <h4 style={{ fontSize: "0.95rem", fontWeight: "700", color: "var(--text-1)", margin: 0 }}>
                            {title}
                        </h4>
                        <button
                            onClick={(e) => {
                    ...
                    <p style={{ fontSize: "0.85rem", color: "var(--text-2)", margin: "0 0 0.5rem 0", lineHeight: 1.5 }}>
                        {message}
                    </p>
            ...
            <div>
                {notifications.length === 0 ? (
                    <div className="empty-state" style={{ padding: "3rem 1rem" }}>
                        ...
                        <p style={{ color: "var(--muted)", fontSize: "0.9rem" }}>No hay notificaciones</p>
                    </div>
                ) : (
